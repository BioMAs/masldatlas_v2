    ...
    <div className="space-y-6">
       ...
       <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <UMAPPlotCard 
             ...
             umapData={umapGene}
             emptyText={!selectedGene ? "Select a gene to view expression" : "No data"}
          />
...
function UMAPPlotCard({ title, subtitle, isLoading, umapData, emptyText }: {
  title: string; subtitle?: string; isLoading: boolean; umapData?: UMAPDataResponse; emptyText?: string;
}) {
